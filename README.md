...
In addition to tracks.en.php, I have added German/French localizations (tracks.de.php,tracks.fr.php) containing labels and venues (Thanks to @ThibautPlg for French localization). The file to be used can be specified at the beginning of index.php.
